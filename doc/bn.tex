...
\subsection{Example}
Example given for \texttt{mp\_log\_u32} only because the single difference is the type of \texttt{base}.
\begin{small}
  \begin{alltt}
#include <stdlib.h>
#include <stdio.h>
...
int main(int argc, char **argv)
{
   ...
   if ((e = mp_log_u32(&x, base, &output)) != MP_OKAY) {
      fprintf(stderr,"mp_log_u32 failed: \textbackslash{}"%s\textbackslash{}"\textbackslash{}n",
                      mp_error_to_string(e));
      exit(EXIT_FAILURE);
   }
   printf("%" PRIu32 "\n",output);
