...
solution ("lib" .. tgtname)
    ...
    project (tgtname)
        local outdir   = "MSVC_" .. action .. "\\$(" .. transformMN("Configuration") .. ")_$(" .. transformMN("Platform") .. ")"
        ...
        defines         {"WIN32_LEAN_AND_MEAN", "WINVER=0x0501", "_CRT_SECURE_NO_WARNINGS", "_CRT_NONSTDC_NO_DEPRECATE",}
