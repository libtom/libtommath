...
mp_is_square.o mp_kronecker.o mp_lcm.o mp_log.o mp_log_u32.o mp_lshd.o mp_mod.o mp_mod_2d.o \
...
s_mp_exptmod.o s_mp_exptmod_fast.o s_mp_get_bit.o s_mp_invmod.o s_mp_invmod_odd.o s_mp_log_2expt.o \
...
s_mp_radix_map.o s_mp_radix_size_overestimate.o s_mp_rand_jenkins.o s_mp_rand_platform.o s_mp_sqr.o \
