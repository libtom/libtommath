...
s_mp_div_school.o s_mp_div_small.o s_mp_eratosthenes.o s_mp_eratosthenes_init.o \
s_mp_eratosthenes_segment.o s_mp_eratosthenes_segment_init.o s_mp_exptmod.o s_mp_exptmod_fast.o \
s_mp_get_bit.o s_mp_init_single_segment_with_start.o s_mp_invmod.o s_mp_invmod_odd.o s_mp_isqrt.o \
s_mp_log.o s_mp_log_2expt.o s_mp_log_d.o s_mp_montgomery_reduce_comba.o s_mp_mul.o s_mp_mul_balance.o \
...
s_mp_rand_platform.o s_mp_sieve_clear.o s_mp_sieve_get.o s_mp_sieve_nextset.o s_mp_sieve_setall.o \
s_mp_sqr.o s_mp_sqr_comba.o s_mp_sqr_karatsuba.o s_mp_sqr_toom.o s_mp_sub.o s_mp_zero_buf.o \
s_mp_zero_digs.o
