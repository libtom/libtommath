...
clean:
	rm -f *.gcda *.gcno *.gcov *.bat *.o *.a *.obj *.lib *.exe *.dll etclib/*.o demo/test.o demo/main.o demo/opponent.o demo/prng.o test timing mpitest mtest/mtest mtest/mtest.exe \
