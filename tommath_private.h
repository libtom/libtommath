 ...
 */
MP_PRIVATE mp_err s_mp_reduce(mp_int *x, const mp_int *m, const mp_int *mu) MP_WUR;

/* returns 1 if a is a valid DR modulus */
MP_PRIVATE bool s_mp_dr_is_modulus(const mp_int *a) MP_WUR;

/* sets the value of "d" required for mp_dr_reduce */
MP_PRIVATE void s_mp_dr_setup(const mp_int *a, mp_digit *d);

/* reduces a modulo n using the Diminished Radix method */
MP_PRIVATE mp_err s_mp_dr_reduce(mp_int *x, const mp_int *n, mp_digit k) MP_WUR;

/* returns true if a can be reduced with mp_reduce_2k */
MP_PRIVATE bool s_mp_reduce_is_2k(const mp_int *a) MP_WUR;

/* determines k value for 2k reduction */
MP_PRIVATE mp_err s_mp_reduce_2k_setup(const mp_int *a, mp_digit *d) MP_WUR;

/* reduces a modulo b where b is of the form 2**p - k [0 <= a] */
MP_PRIVATE mp_err s_mp_reduce_2k(mp_int *a, const mp_int *n, mp_digit d) MP_WUR;

/* returns true if a can be reduced with mp_reduce_2k_l */
MP_PRIVATE bool s_mp_reduce_is_2k_l(const mp_int *a) MP_WUR;

/* determines k value for 2k reduction */
MP_PRIVATE mp_err s_mp_reduce_2k_setup_l(const mp_int *a, mp_int *d) MP_WUR;

/* reduces a modulo b where b is of the form 2**p - k [0 <= a] */
MP_PRIVATE mp_err s_mp_reduce_2k_l(mp_int *a, const mp_int *n, const mp_int *d) MP_WUR;
